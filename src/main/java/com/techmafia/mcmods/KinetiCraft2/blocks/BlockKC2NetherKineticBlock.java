...
public class BlockKC2NetherKineticBlock extends Block {
    ...
    public BlockKC2NetherKineticBlock() {
        ...
        this.setBlockName("netherKineticBlock");
        this.setBlockTextureName(Reference.TEXTURE_NAME_PREFIX + "netherKineticBlock");
    ...
    public void registerBlockIcons(IIconRegister iconRegister) {
        this.blockIcon = iconRegister.registerIcon(Reference.TEXTURE_NAME_PREFIX + "netherKineticBlock");
    }
    ...
    public void makeKineticDust(World world, int x, int y, int z, int amount) {
        ...
        world.spawnEntityInWorld(new EntityItem(world, x, y, z, new ItemStack(KinetiCraft2Items.netherKineticDust, amount)));
    }
}