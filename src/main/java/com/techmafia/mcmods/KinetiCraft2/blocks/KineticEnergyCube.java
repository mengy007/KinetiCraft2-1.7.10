...
import com.techmafia.mcmods.KinetiCraft2.blocks.base.KC2BlockBase;
 ...
 */
public class KineticEnergyCube extends KC2BlockBase {
    ...
    public void onBlockPlacedBy(World world, int x, int y, int z, EntityLivingBase entity, ItemStack itemStack)
    {
        ...
        //KineticEnergyCubeTileEntity tileEntity = (KineticEnergyCubeTileEntity)world.getTileEntity(x
        , y, z);
        EnergyCubeTileEntity tileEntity = (
        EnergyCubeTileEntity)world.getTileEntity(x, y, z);
