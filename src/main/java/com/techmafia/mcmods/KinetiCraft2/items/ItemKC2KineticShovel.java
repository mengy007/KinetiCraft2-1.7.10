...
/**
 * Created by myang on 10/21/15.
 */
public class ItemKC2KineticShovel extends ItemSpade implements IEnergyContainerItem {
    ...
    public ItemKC2KineticShovel(ToolMaterial toolMaterial, String shovelName, int capacity, int maxTransfer, int energyFromUsing, int overChargeBuffer, float overChargeDamage) {
        super(toolMaterial);
